...
<body>
	...
	<div class="d-flex justify-content-center h-100">
		<div class="user_card">
			...
			<spr:form action="login.cdac" method="post" commandName="student">
					<div class="input-group mb-3">
						<div class="input-group-append">
							<span class="input-group-text"><i class="fa fa-user-o" aria-hidden="true"></i></span>
						</div>
						<input type="text" name="studentId" class="form-control input_user" value="" placeholder="user id">
					...
					<div class="input-group mb-2">
						...
						<input type="password" name="studentPass" class="form-control input_pass" value="" placeholder="password">
			...
			<div class="mt-4">
				...
				<div class="d-flex justify-content-center links">
					<a href="forgot_pass_form.jsp">Forgot your password?</a>
				</div>
			</div>
		</div>
	</div>
